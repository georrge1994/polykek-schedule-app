...
import com.android.core.ui.mvi.MviComposeFragment
 ...
 */
abstract class NavigationComposeFragment<I : MviIntent, S : MviState, A : MviAction, VM : MviViewModel<I, S, A>> :
    MviComposeFragment<I, S, A, VM>() {
    @Inject
